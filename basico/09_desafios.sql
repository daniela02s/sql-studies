...
contendo os mais novos nas primeiras linhas e os mais velhos nas últimas. Realize este ajuste na consulta feita no desafio 1.
*/
...
/*
DESAFIO 3: ​Parece haver um problema na tabela 'cadastro' do desafio 1.
Como uma forma de estudar uma amostra dela, você decide pegar somente as primeiras 20 linhas.
...
você agora precisa passar para seu chefe qual a idade média dos clientes da empresa. Escreva a query que realiza essa consulta.
*/
...
Retorne a coluna com a contagem com o nome 'Maior_de_Idade​'.você agora precisa passar para seu chefe qual a idade média dos clientes da empresa.
...
/*
DESAFIO 7: A área financeira precisa que você identifique na tabela 'cadastro' quantos clientes têm entre 30 e 40 anos.
...
/*
DESAFIO 8: Verifique a distribuição de clientes por faixa etária agrupando-os em 'menores de 18', '18 a 65' e 'maiores de 65'.​
